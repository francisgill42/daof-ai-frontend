...
<v-flex xs12 md6>
<v-text-field class="red_class" v-model="name"  label="Name" :value="Caps"></v-text-field>
</v-flex>

<v-flex xs12 md6>
<v-text-field class="red_class" v-model="fathername"  label="Father Name" :value="Caps"></v-text-field>
</v-flex>
...
<v-flex xs12 md6>
<v-text-field class="red_class" v-model="nationality"  label="Nationality" :value="Caps"></v-text-field>
</v-flex> 
<v-flex xs12 md6>
<v-text-field class="red_class" v-model="religion"  label="Religion" :value="Caps"></v-text-field>
</v-flex> 
 <v-flex md12>
   ...
   <v-flex md12>
    ...
    <v-radio label="No" value="no"></v-radio>
     ...
     <v-flex md12>
    <label class="mb-3">Do you hold US Permanent Resident Card (Green Card)?</label>
    <v-radio-group v-model="tax_status"  >
    <v-radio label="Yes" value="yes"></v-radio>
    <v-radio label="No" value="no"></v-radio>
    </v-radio-group>
   ...
   <v-flex xs12 md6>
   <v-text-field class="red_class" v-model="tel" label="Tel No (Res)"></v-text-field>
   </v-flex>

   <v-flex xs12 md6>
   <v-text-field class="red_class" v-model="tel_office" label="Office" :value="Caps"></v-text-field>
   </v-flex>

   <v-flex xs12 md6>
   <v-text-field class="red_class" v-model="fax" label="Fax" :value="Caps"></v-text-field>
   </v-flex>

   <v-flex xs12 md6>
   <v-text-field class="red_class" v-model="mobile_no" label="Mobile No" :value="Caps"></v-text-field>
   </v-flex>
